          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col">
                <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                  <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Kadhi Details</li>
                  </ol>
                </nav>
              </div>
            </div>
              <div class="card">
                <div class="row">
                    <div class="col-md-10">
                        <h5 class="card-header">Kadhi Table</h5>
                    </div>
                </div>
                  ...
                  <table id="example1" class="table table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{getbackstich($lot->lot_id)}}</td>
                        <td>{{getfrontstich($lot->lot_id)}}</td>
                        <td>{{gettotalamountstich($lot->lot_id)}}</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                               <a class="dropdown-item" href="{{url('addkadhilot/' .$lot->lot_id)}}"
