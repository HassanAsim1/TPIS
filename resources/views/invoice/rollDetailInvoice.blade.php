        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <div class="invoice-print p-3">
                    ...
                    <div class="row pb-2">
                        <div class="col-sm-6">
                            <h6 class="mb-1">Ledger of:</h6>
                            <p class="mb-25">{{getpartieaddress($PRTYID->partie_id)->name}}</p>
                            <p class="mb-25">{{getpartieaddress($PRTYID->partie_id)->address}}</p>
                            <p class="mb-25">Contact #: {{getpartieaddress($PRTYID->partie_id)->phone_no}}</p>
                        </div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><strong>Rs : {{number_format(cal_current_amount($PRTYID->partie_id))}}</strong></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                            <div class="invoice-total-wrapper">
                                ...
                                <div class="invoice-total-item">
                                    ...
                                    <p class="invoice-total-amount">{{number_format(cal_current_amount($PRTYID->partie_id))}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
