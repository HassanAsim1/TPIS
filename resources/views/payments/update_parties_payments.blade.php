        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Edit Your Payment 🚀</h4>
     

              <form id="formAuthentication" class="mb-3" action="{{url('edit_partie_cash_payment')}}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="trans_id" name="trans_id" value="{{$data->trans_id}}" />
                </div> 
               ...
               <div class="mb-3">
                ...
                @if($data->debit != '')
                <div class="mb-3">
                  <label for="phonenumber" class="form-label">Debit</label>
                  <input
                    type="text"
                    class="form-control"
                    name="debit"
                ...
                @else
                <div class="mb-3">
                  <label for="phonenumber" class="form-label">Credit</label>
                  <input
                    type="text"
                    class="form-control"
                    name="credit"
                ...
                <div class="mb-3">
                  <label for="cnic" class="form-label">Edit By</label>
                  <input
                    type="text"
                    class="form-control"
                    name="given_by"
