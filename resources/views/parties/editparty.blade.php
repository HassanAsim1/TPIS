        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Edit Your PartyInformation 🚀</h4>
     

              <form id="formAuthentication" class="mb-3" action="/editparty" method="POST">
                @csrf

                <input type="hidden" name="partie_id" value="{{$data->partie_id}}">
               ...
               <div class="mb-3">
                ...
                <!-- <div class="mb-3">
                  <label for="cnic" class="form-label">Opening Balance</label>
                  <input
                    type="text"
                    class="form-control"
                    id="opening_balance"
