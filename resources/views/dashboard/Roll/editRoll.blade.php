		...
		<div>
			<div class="row row_fuild">
				<div class="col-md-4">
					...
					<select class="form-control" name="partieId" id="parties_id" required>
                          ...
                          @php $count = 0; @endphp
                            ...
                            @foreach($rollData as $lot)
                                <div class="row" style="margin-top:10px;">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" onkeydown="totalval({{$count}})" id="srate{{$count}}" value="{{$lot->rollRate}}" name="srate[]" placeholder="Rate" required/>
                                    </div>
                                    <div class="col-sm-2">
                            ...
                            <div class="row justify-content-end">
                              ...
                              <input type="text" class="form-control" id="totalquan" name="total_quantity" value="{{$roll->totalRollQuantity}}" placeholder="Total Quantity" readonly/>
                              </div>
                              <div class="col-sm-3 mb-3">
                              <label class="col-form-label" for="basic-default-company">Grand-Total :</label>
                              <input type="number" class="form-control stotal" id="grandtotal" name="grandtotal" value="{{$roll->totalAmount}}" placeholder="Grand Total" readonly/>
                              </div>
                              <div class="col-sm-3">
